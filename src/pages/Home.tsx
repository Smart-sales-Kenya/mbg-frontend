  ...
  const programs = [
    {
      ...
      description:
        "Comprehensive training for business owners and sales managers to build a high-performing commercial engine",
      price: "Ksh 76,560",
    ...
    },
    {
      ...
      description:
        "One-day intensive workshop to design and document your sales process",
      price: "Ksh 12,760",
      link: "/programs#training",
    },
    {
      ...
      description:
        "6-month program moving teams from order-taking to strategic selling",
      price: "Custom",
    ...
    },
    {
      ...
      description:
        "1-2 day intensive with tools, frameworks, and real-world cases",
      price: "Custom",
